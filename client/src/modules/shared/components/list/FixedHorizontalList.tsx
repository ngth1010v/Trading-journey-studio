...
import style from "./css/FixedHorizontalList.module.css";
...
export interface FixedHorizontalListProps {
  children: React.ReactNode;
  selectedList?: boolean[];
  dividerList?: boolean[];
}

export default function FixedHorizontalList({
  children,
  selectedList = [],
  dividerList = [],
}: FixedHorizontalListProps) {
  //---------------------------------------
  // Theme Data Setup
  //---------------------------------------
  ...
  return (
    <div className={style.FixedHorizontalList} style={inlineThemeStyle}>
